package clas.daniel.notes.view;
...
public class RichTextEditor extends ScrollView {
	...
	public RichTextEditor(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		EditText firstEdit = createEditText("Content", dip2px(context, EDIT_PADDING));
	...
	private RelativeLayout createImageLayout() {
		View view=activity.findViewById(R.id.et_new_content);
		LayoutInflater inflater=LayoutInflater.from(getContext());
		View addedlayout =inflater.inflate(R.layout.edit_imageview, null);
		addedlayout.setTag(viewTagIndex++);

		View imageView = addedlayout.findViewById(R.id.edit_imageView);
		imageView.setOnClickListener(btnListener);
		return (RelativeLayout) addedlayout;
	}
	int dpToPx(int dps) {
	...
	public void addEditTextAtIndex(final int index, CharSequence editStr) {
		EditText editText2 = createEditText("Content Here", EDIT_PADDING);
	...
	public void addImageViewAtIndex(final int index, Bitmap bmp, String imagePath) {
		...
		RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(
				LayoutParams.MATCH_PARENT, 500);//TODO 固定图片高度500，考虑自定义属性
		lp.bottomMargin = 10;

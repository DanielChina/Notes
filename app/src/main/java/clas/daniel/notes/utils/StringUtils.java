...
public class StringUtils {
    ...
    /**
     * @param targetStr this is to divide the string into pieces of text or img
     *
     */
    ...
    public static String getFirstImgPathFromStringData(String data){
        String firstImagePath;
        List<String> textList = new ArrayList<>();
        List<String> list = cutStringByImgTag(data);
    ...
    public static String getTextFromStringData(String data){
        String text="";
        List<String> list = cutStringByImgTag(data);
        for (int i = 0; i < list.size(); i++) {
            String tx = list.get(i);
